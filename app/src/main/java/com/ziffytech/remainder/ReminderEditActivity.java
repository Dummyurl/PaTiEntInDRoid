...
public class ReminderEditActivity extends CommonActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rb = new DataProvider();
        mReceivedReminder = rb.getReminder(mReceivedID,this);
    ...
    public void updateReminder(){
        ...
        // Update reminder
        rb.updateReminder(mReceivedReminder,this);
