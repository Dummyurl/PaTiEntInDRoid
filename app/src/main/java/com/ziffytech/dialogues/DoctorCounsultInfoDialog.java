...
public class DoctorCounsultInfoDialog extends Dialog {

    private Activity mContext;
    private SharedPreferences sharedPreferences;
    DoctorModel doctorModel;

    public DoctorCounsultInfoDialog(final Activity context, DoctorModel arrayList) {
        super(context);
        this.requestWindowFeature(1);
        this.setContentView(R.layout.consult_doctor_dialog);
