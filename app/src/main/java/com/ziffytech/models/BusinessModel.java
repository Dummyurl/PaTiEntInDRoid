...
public class BusinessModel {
    ...
    public String getBus_google_street() {
        return bus_google_street;
    }

    public void setBus_google_street(String bus_google_street) {
        this.bus_google_street = bus_google_street;
    }
    ...
    public void setBus_con_time(String bus_con_time) {
        this.bus_con_time = bus_con_time;
    }
    ...
    public void setIs_trusted(String is_trusted) {
    ...
    public void setMorning_time_start(String morning_time_start) {
    ...
    public void setEvening_time_end(String evening_time_end) {
