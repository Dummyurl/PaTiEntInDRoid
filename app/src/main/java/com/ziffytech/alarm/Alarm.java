...
public class Alarm implements Comparable<Alarm>
{
  ...
  public String getmRemaiderName() {
    return mRemaiderName;
  }

  public void setmRemaiderName(String mRemaiderName) {
    this.mRemaiderName = mRemaiderName;
  }

  private String mRemaiderName;
  ...
  public void toIntent(Intent intent)
  {
    ...
    intent.putExtra("com.taradov.alarmme.com.ziffytech.alarm", mEnabled);
  ...
  public void fromIntent(Intent intent)
  {
    ...
    mEnabled = intent.getBooleanExtra("com.taradov.alarmme.com.ziffytech.alarm", true);
