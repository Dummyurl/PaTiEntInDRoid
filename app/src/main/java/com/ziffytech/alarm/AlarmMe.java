...
public class AlarmMe extends CommonActivity
{
...
//    mAlarmListAdapter.save();
  ...
  /*  else if (index == CONTEXT_MENU_DUPLICATE)
    {
      Alarm com.ziffytech.alarm = mAlarmListAdapter.getItem(info.position);
      Alarm newAlarm = new Alarm(this);
      Intent intent = new Intent();

      com.ziffytech.alarm.toIntent(intent);
      newAlarm.fromIntent(intent);
      newAlarm.setTitle(com.ziffytech.alarm.getTitle() + " (copy)");
