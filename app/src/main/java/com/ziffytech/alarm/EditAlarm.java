...
public class EditAlarm extends CommonActivity {
    ...
    private CheckBox dose_m,dose_a,dose_e,dose_n;
    ...
    public void onCreate(Bundle bundle) {
        ...
        dose_m=(CheckBox)findViewById(R.id.dose_m);
        dose_a=(CheckBox)findViewById(R.id.dose_a);
        dose_e=(CheckBox)findViewById(R.id.dose_e);
        dose_n=(CheckBox)findViewById(R.id.dose_n);

        dose_m.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
        ...
        dose_a.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        dose_e.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
        ...
        dose_n.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
