 ...
 */
public class KnowMoreListAdapter extends RecyclerView.Adapter<KnowMoreListAdapter.ProductHolder>{
    private  Activity activity;
    private CommonClass common;
    private ArrayList<BusinessModel> postItems;

    public KnowMoreListAdapter(Activity con, ArrayList<BusinessModel> array){
        activity = con;
            postItems = array;
